...
import io.github.hydrazinemc.hydrazine.server.crafts.pilotables.starships.subsystems.weapons.projectiles.LightCannonProjectile
...
enum class WeaponType(
	...
	LIGHT_CANNON(LightCannonProjectile, OriginRelative(6, 0, 0), PI / 8, OriginRelative(2, 0, 0),1,"light_cannon");
